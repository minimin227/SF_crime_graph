...
default_sql = "SELECT t.dates, t.category, t.dayofweek, t.pddistrict, t.resolution, t.x, t.y, t.d_code, r.resolution_score, d.severity_score, d.severity_score/r.resolution_score AS severity_per_resolution FROM train t JOIN resolution_score r ON t.resolution=r.resolution JOIN descript_severity d ON t.d_code=d.d_code WHERE dates BETWEEN '2015-01-01' AND '2015-05-14';"
